...
<div style="background: rgb(221, 243, 254);padding: 10px 0px 1px 0px;height: 45px">
			<span  id="prev_discount_product" class="flaticon-rewind44" style="width: 10%;float: left;margin-left: 5px"></span> 
			<h2 class="text-center text-primary" style="width: 80%;float: left">Giảm giá</h2>
			<span id="next_discount_product" class="flaticon-fast44" style="float: right;margin-right: 5px"></span> 
</div>
<div class="row" style="margin-right: -50px;margin-left: -30px">
<div class="col-md-12 margin-vert-10">
	<div id="discount-product" class="owl-carousel owl-theme " >
...
<script type="text/javascript">
		$(document).ready(function() {
			var owl = $("#discount-product");
			  ...
			  $("#next_discount_product").click(function(){
			    owl.trigger('owl.next');
			  })
			  $("#prev_discount_product").click(function(){
