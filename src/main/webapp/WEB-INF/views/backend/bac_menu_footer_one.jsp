...
<div
   ...
   <div
      ...
      <div class="widget-header">
         <h5 class="widget-title">Menu Footer One</h5>
               ...
               <tbody>
                  <tr ng-repeat="menu in menus track by $index">
                     ...
                     <td
                        ...
                        data-toggle="tooltip"
                        onmouseover="themHieuUngXoay(this)" onmouseout="xoaHieuUngXoay(this)"
               ...
               <div class="modal-body">
                  <div class="bootbox-body">
                     <div class="form-group">
                        <label><spring:message code="customer.name" /> *</label> <input
                           type="text"
                           name="name"
                           class="form-control"
                           ng-model="menu.name"
...
function todoListController($scope, $http) {
	...
	todoList.loadMenu = function(id) {
		$http.get('find_conect_link_by_type'+"/MENU_FOOTER_ONE").success(function(data){
	  		$scope.menus = data;
        });
	};
	...
	todoList.createNew = function(){
		$scope.menu = {};
		$scope.menu.type = "MENU_FOOTER_ONE";
		$("#detailMenu").modal();
	};
